...
```sh
$ npm install capstone-intl --save
```
...
var mongoose     = require('mongoose'),
    capstoneIntl = require('capstone-intl'),
...
```js
BlogPost.plugin(capstoneIntl, { languages: ['en', 'de', 'fr'], defaultLanguage: 'en' });
```

or it can be defined as a global plugin which will be applied to all schemas:

```js
mongoose.plugin(capstoneIntl, { languages: ['en', 'de', 'fr'], defaultLanguage: 'en' });
```
